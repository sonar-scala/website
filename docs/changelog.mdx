...
- Implemented a new mode for pull request decoration. In this mode, sonar-scala
  ...
  [here](https://github.com/mwz/sonar-scala#pull-request-decoration-new).
  ([#196](https://github.com/mwz/sonar-scala/issues/196),
  [#316](https://github.com/mwz/sonar-scala/issues/316),
  [#318](https://github.com/mwz/sonar-scala/issues/318),
  [#319](https://github.com/mwz/sonar-scala/issues/319),
  [#324](https://github.com/mwz/sonar-scala/issues/324) -
...
- Added support for
  ...
  ([#260](https://github.com/mwz/sonar-scala/issues/260) -
  [@mwz](https://github.com/mwz))
...
- Added support for [SonarQube 7.8](https://www.sonarqube.org/sonarqube-7-8).
  ([#234](https://github.com/mwz/sonar-scala/issues/234) -
  [@mwz](https://github.com/mwz))
- Updated Scapegoat to
  ...
  ([#227](https://github.com/mwz/sonar-scala/issues/227) -
  [@mwz](https://github.com/mwz))
...
- Added support for [SonarQube 7.7](https://www.sonarqube.org/sonarqube-7-7).
  ([#182](https://github.com/mwz/sonar-scala/issues/182) -
  [@mwz](https://github.com/mwz))
...
- Added support for [SonarQube 7.6](https://www.sonarqube.org/sonarqube-7-6).
  ([#152](https://github.com/mwz/sonar-scala/issues/152) -
...
- Added an optional `sonar.scala.scoverage.disable` property, which can be used
  ...
  ([#169](https://github.com/mwz/sonar-scala/issues/169) -
  [@BalmungSan](https://github.com/BalmungSan))
...
- Backported features and bug fixes from the 7.x series - new unit test metrics
  ...
  more details. ([#164](https://github.com/mwz/sonar-scala/issues/164) -
  [@mwz](https://github.com/mwz))
...
- Fixed Scalastyle rule lookup for custom rules created from templates.
  ([#148](https://github.com/mwz/sonar-scala/issues/148) -
...
- Implemented a new sensor which saves unit test metrics such as unit test
  ...
  [sample](https://github.com/mwz/sonar-scala/examples/) projects for example
  configuration for each build tool.
  ([#143](https://github.com/mwz/sonar-scala/issues/143) -
  [@mwz](https://github.com/mwz))
- Fixed incorrect log messages about missing `sonar.scala.version` property.
  ([#139](https://github.com/mwz/sonar-scala/issues/139) -
  [@mwz](https://github.com/mwz))
...
- Backported features from the 7.x series - new `Recommended by sonar-scala`
  ...
  more details. ([#136](https://github.com/mwz/sonar-scala/issues/136) -
  [@mwz](https://github.com/mwz))
...
- Added a new quality profile `Recommended by sonar-scala`, which is a
  ...
  the community. ([#130](https://github.com/mwz/sonar-scala/issues/130) -
  [@mwz](https://github.com/mwz))
- Cleaned up Scapegoat rule repository and quality profiles by removing any
  ...
  ([#132](https://github.com/mwz/sonar-scala/issues/132) -
  [@mwz](https://github.com/mwz))
...
- Added support for [SonarQube 7.4](https://www.sonarqube.org/sonarqube-7-4).
  ([#127](https://github.com/mwz/sonar-scala/issues/127) -
  [@mwz](https://github.com/mwz))
...
- Added support for [SonarQube 7.3](https://www.sonarqube.org/sonarqube-7-3).
  ...
  ([#120](https://github.com/mwz/sonar-scala/issues/120) -
  [@mwz](https://github.com/mwz))
- Removed the following:
  ...
  - the old Scalastyle quality profile and rule registry which were deprecated
    in [6.6.0](https://github.com/mwz/sonar-scala/releases/tag/v6.6.0);
    ([#120](https://github.com/mwz/sonar-scala/issues/120) -
    [@mwz](https://github.com/mwz))
...
- Refactored Scalastyle module and introduced new Scalastyle rules repository
  ...
  sensor. ([#35](https://github.com/mwz/sonar-scala/issues/35) -
  [@mwz](https://github.com/mwz))
- New `Scalastyle+Scapegoat` quality profile, which includes all of the default
  ...
  ([#112](https://github.com/mwz/sonar-scala/issues/112) -
  [@BalmungSan](https://github.com/BalmungSan))
- Bumped Scapegoat up to `1.3.7`, which introduces a new inspection
  ...
  details. ([#100](https://github.com/mwz/sonar-scala/issues/100) -
  [@mwz](https://github.com/mwz))
- Scapegoat sensor now also works with absolute file paths in the Scapegoat
  report. ([#116](https://github.com/mwz/sonar-scala/issues/116) -
  [@mwz](https://github.com/mwz))
...
- This release fixes an issue with Scapegoat sensor using a single report for
  ...
  ([#96](https://github.com/mwz/sonar-scala/issues/96) -
  [@mwz](https://github.com/mwz))
...
- Introduced support for [Scapegoat](https://github.com/sksamuel/scapegoat)
  ...
  ([#8](https://github.com/mwz/sonar-scala/issues/8) -
...
- Improved logging in the Scoverage sensor.
  ([#61](https://github.com/mwz/sonar-scala/issues/61) -
  [@BalmungSan](https://github.com/BalmungSan))
- Fixed Scoverage issues with multi-module Gradle projects. Please see the
  ...
  analysis. ([#63](https://github.com/mwz/sonar-scala/issues/63) -
  [@mwz](https://github.com/mwz))
...
- Use semantic versioning scheme to parse the `sonar.scala.version` property.
  ...
  defaults to `2.11.0`. ([#53](https://github.com/mwz/sonar-scala/issues/53) -
  [@BalmungSan](https://github.com/BalmungSan))
- Fixed an issue which affected Gradle users and caused the sonar sources prefix
  ...
  ([#56](https://github.com/mwz/sonar-scala/issues/56) -
  [@mwz](https://github.com/mwz))
...
- Added support for multiple source locations configured by the `sonar.sources`
  ...
  ([#52](https://github.com/mwz/sonar-scala/issues/52) -
  [@mwz](https://github.com/mwz))
- The Scoverage report path property `sonar.scoverage.reportPath` was deprecated
  ...
  `sonar.scala.scoverage.reportPath` instead.
  ([#46](https://github.com/mwz/sonar-scala/issues/46) -
  [@BalmungSan](https://github.com/BalmungSan))
...
- The Scoverage sensor was rewritten from scratch; introduced a new branch
  coverage metric. ([#34](https://github.com/mwz/sonar-scala/issues/34) -
  [@BalmungSan](https://github.com/BalmungSan))
- Addressed coverage measure warnings reported by sonar-scanner during analysis.
  ([#18](https://github.com/mwz/sonar-scala/issues/18) -
  [@BalmungSan](https://github.com/BalmungSan))
- Added a new property `sonar.scala.version` to specify Scala version.
  ([#2](https://github.com/mwz/sonar-scala/issues/2) -
...
- Support for SonarQube 6.7.1 LTS.
  ([#5](https://github.com/mwz/sonar-scala/issues/5) -
  [@mwz](https://github.com/mwz))
