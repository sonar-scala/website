...
request
[1](https://github.com/sonar-scala/sonar-scala-pr-annotation-example/pull/1) in
the
[mwz/sonar-scala-pr-annotation-example](https://github.com/sonar-scala/sonar-scala-pr-annotation-example)
