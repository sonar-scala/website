...
import { vars, Prism, Highlight } from "../../scalaHighlight";
...
<div className="alert alert--info" role="alert">
  This plugin is particularly useful when used together with sbt-release for an
  automated release process in your project, but it can be also used without
  sbt-release.
</div>
...
<Highlight Prism={Prism} className="language-scala">
